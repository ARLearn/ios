 ...
 */
#define ELog(error) if (ARLLog.LogOn && error) { NSLog(@"[%s:%d] %@ [%ld]: %@", __PRETTY_FUNCTION__, __LINE__, NSLocalizedString(@"Error", @"Error"), (long)[error code], [error localizedDescription] ); }
